...
import { faArrowRight, faSmile, faMapMarkerAlt } from '@fortawesome/free-solid-svg-icons'
...
export default {
    ...
    created() {
        library.add(faArrowRight, faCircle, faCheckCircle, faSmile, faMapMarkerAlt)
    },
